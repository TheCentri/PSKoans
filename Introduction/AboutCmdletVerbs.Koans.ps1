...
Describe "Basic Verbs" {
    ...
    Context "Add" {
        ...
        It 'is for commands that append data' {
            ...
            #>
            $Answers = "Add-PrinterPort", "Add-VpnConnectionRoute", "Add-CertificateEnrollmentPolicyServer", "Add-Content", "Add-WindowsDriver"
    ...
    Context "Set" {
        ...
        It 'is for commands that overwrite data' {
            ...
            #>
            $Answers = "Set-Volume", "Set-VpnConnectionIPsecConfiguration", "Set-AppLockerPolicy", "Set-AuthenticodeSignature", "Set-StoragePool"
    ...
    Context "Remove" {
        ...
        #>
            $Answers = "Remove-JobTrigger", "Remove-Event", "Remove-PSSession", "Remove-WindowsPackage", "Remove-WSManInstance"
        ...
        It 'can Remove-Item to delete a file' {
            ...
            <#
                ...
                #>
            #$Message = "Remove-Item: Cannot find path 'C:\Users\Brandon\AppData\Local\Temp\YOUR_PATH.txt' because it does not exist."
