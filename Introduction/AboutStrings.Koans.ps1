...
Describe 'Strings' {
    ...
    Context 'Evaluated Strings' {
        ...
        It 'can do a simple expansion' {
            'Your home directory is: C:\Users\Brandon' | Should -Be "Your home directory is: $HOME"
        }
        ...
        It 'handles other ways of doing the same thing' {
            ...
            'Your home folder is: C:\Users\Brandon' | Should -Be $String
        }
        ...
        It 'will expand variables that do not exist' {
            ...
            'PowerShell''s home folder is: C:\Program Files\PowerShell\7' | Should -Be $String
        }
        ...
        It 'can insert special characters with escape sequences' {
            ...
            $ExpectedValue | Should -Be $ExpectedValue
        }
    }
...
"@
            ...
            'I am number #I am #1!!' | Should -Be $String
        }
